...
public class ChatClient extends JApplet implements Runnable,
    ...
    private String[][] emos = {{":-)", ":-P", ":-D", "^^", ":-o", ":-(", "-.-", ";-D", "xD"},
        {"emoticon_smile.png", "emoticon_tongue.png", "emoticon_grin.png", "emoticon_happy.png", "/emoticon_surprised.png", "emoticon_unhappy.png", "emoticon_waii.png", "emoticon_wink.png", "emoticon_evilgrin.png"}};
    ...
    public static void main(String[] args) {
        if (args.length == 0) {
            ...
            if (args.length != 2) {
                LOG.error("java ChatClient <host> <port>");
                System.exit(1);
            } else {
                standalone = true;
    ...
    public static void impMain(String ip, int port) {
